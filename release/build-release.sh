...
mkdir ./cronometer-export-release-tmp/cronometer-export-macosx-arm64-$VERSION
...
env GOOS=darwin GOARCH=amd64 go build -o ./release/cronometer-export-release-tmp/cronometer-export-macosx-arm64-$VERSION/
...
env GOOS=windows GOARCH=amd64 go build -o ./release/cronometer-export-release-tmp/cronometer-export-windows-amd64-$VERSION/cronometer-export.exe

cd ./release/cronometer-export-release-tmp
zip -r ./cronometer-export-macosx-amd64.zip ./cronometer-export-macosx-amd64-$VERSION
zip -r ./cronometer-export-macosx-amd64.zip ./cronometer-export-macosx-arm64-$VERSION
zip -r ./cronometer-export-freebsd-amd64.zip ./cronometer-export-freebsd-amd64-$VERSION
zip -r ./cronometer-export-linux-amd64.zip ./cronometer-export-linux-amd64-$VERSION
zip -r ./cronometer-export-linux-arm64.zip ./cronometer-export-linux-arm64-$VERSION
zip -r ./cronometer-export-openbsd-amd64.zip ./cronometer-export-openbsd-amd64-$VERSION
zip -r ./cronometer-export-openbsd-arm64.zip ./cronometer-export-openbsd-arm64-$VERSION
zip -r ./cronometer-export-windows-amd64.zip ./cronometer-export-windows-amd64-$VERSION
